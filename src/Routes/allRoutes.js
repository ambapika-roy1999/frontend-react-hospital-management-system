...
import AddDoctorSpecialization from "../pages/AddDoctorSpecialization/DoctorSpecial";
import EditDoctorSpecialization from "../pages/AddDoctorSpecialization/EditSpecialization";
...
const authProtectedRoutes = [
  ...
  // eslint-disable-next-line react/display-name
  {
    path: "/",
    exact: true,
    component: localStorage.getItem("user") === null? <Navigate to="/login" />:<Navigate to="/dashboard"/>,
  },
  ...
  {path: "/add-doctor-specialization",component:<AddDoctorSpecialization/>},
  {path: "/edit-doctor-specialization",component:<EditDoctorSpecialization/>},
  {path: "/show-doctor-list",component:<ForceGraph/>}
