...
const Navdata = () => {
    ...
    const [isAddSpecialization, setSpecialization] = useState(false);
    const [isDoctorList, setDoctorList] = useState(false);
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'Specialization') {
            setSpecialization(false);
        }
        if (iscurrentState !== 'DoctorList') {
            setDoctorList(false);
        }
    }, [
        history,
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: "lar la-user-circle",
            link: "/add-doctor-specialization",
            click: function (e) {
                e.preventDefault();
                setAddProduct(!isAddSpecialization);
                setIscurrentState('Specialization');
                updateIconSidebar(e);
            },
            stateVariables: isAddSpecialization,
        ...
        },
        {
            ...
            icon: "lar la-user-circle",
            link: "/show_doctor_list",
            click: function (e) {
                e.preventDefault();
                setDoctorList(!isDoctorList);
                setIscurrentState('DoctorList');
                updateIconSidebar(e);
            },
            stateVariables: isDoctorList,
